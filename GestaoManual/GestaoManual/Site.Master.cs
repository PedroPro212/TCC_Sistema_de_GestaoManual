...
namespace GestaoManual
{
    ...
    {
        //public static string ConnectionString = "Server=mysql5025.site4now.net;User ID=a95df3_metal;Password=Pe212004ho;Database=db_a95df3_metal";  //site upload
        ...
        //public static string ConnectionString = "Server=127.0.0.1;User ID=root;Password=212004;Database=metalurgicasaveiro";  // Computador Pedro
